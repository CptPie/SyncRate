...
func SetupRouter(db *gorm.DB) *gin.Engine {
	...
	// Radio room routes
	r.GET("/create-radio-room", handlers.GetCreateRadioRoom(db))
	r.POST("/create-radio-room", handlers.PostCreateRadioRoom(db))
	...
	// Quiz room routes
	r.GET("/create-quiz-room", handlers.GetCreateQuizRoom(db))
	r.POST("/create-quiz-room", handlers.PostCreateQuizRoom(db))
